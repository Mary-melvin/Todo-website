...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Use the AuthProvider's login function to handle authentication
        ...
        <div className="max-w-md w-full space-y-8 bg-white rounded-2xl shadow-xl p-8 sm:p-10">
          ...
          <div className="mt-8 text-center">
            <p className="text-sm text-gray-600 mb-4">
              ...
              <Link href="/auth/sign-up" className="font-medium text-sky-blue-600 hover:text-sky-blue-800 transition duration-200">
                Sign up
              </Link>
            </p>
          </div>
